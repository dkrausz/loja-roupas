...
employeeRoutes.post(
  ...
  whoHasAcess.permission("ADM"),
  isUniqueEmail.employee,
  Cpf.isValid,
  Cpf.isUniqueEmployee,
  bodyMiddleware.bodyIsValid(createEmployeeSchema),
...
employeeRoutes.get(
  ...
  ValidateToken.execute,
  whoHasAcess.permission("ADM"),
  employeeController.getMany
);

employeeRoutes.get(
  "/:id",
  ValidateToken.execute,
  whoHasAcess.permission("ADM", "owner"),
...
employeeRoutes.patch(
  ...
  ValidateToken.execute,
  whoHasAcess.permission("ADM", "owner"),
  bodyMiddleware.bodyIsValid(updateEmployeeSchema),
...
employeeRoutes.post(
  "/login",
  bodyMiddleware.bodyIsValid(employeeLogin),
