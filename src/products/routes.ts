...
// productRoute.post("/", bodyMiddleware.bodyIsValid(createProductBodySchema), productController.createProduct);
productRoute.post(
  "/",
  ValidateToken.execute,
  whoHasAccess.permission("ADM", "employee"),
  bodyMiddleware.bodyIsValid(createProductBodySchema),
...
productRoute.patch(
  ...
  ValidateToken.execute,
  whoHasAccess.permission("ADM", "employee"),
  bodyMiddleware.bodyIsValid(updateProductSchema),
